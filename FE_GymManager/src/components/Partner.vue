<template>
<div>
    <SupplierAdd v-if="isShowAdd" @toggle-list="toggleList()" :check="3" />
    <SupplierEdit v-if="isShowEdit" :supplierItem="supplierChose"  @toggle-list="toggleList()"  :check="3"/>
        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-6">
                            <h2 >Manage <b>Partnar</b></h2>
                        </div>
                        <div class="col-sm-6">
                            <a @click="changIsShowAdd()" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Partner</span></a>
...
export default {
    computed: {
        ...mapState({
            supplierList :state =>state.partner.supplierList,
            totalPage :state=>state.partner.totalPage
        })
    },
    components: {
        SupplierAdd,
    ...
    methods: {
        ...mapActions('partner', ['getSupplier','deleteSupplier','getByPage']),
        ...mapMutations('partner',['findByName']),
        changIsShowAdd() {
