...
<div>
    ...
    <div class=" contact-form form-post">
        <form @submit.prevent="AddPSD(partnerDevice)" method="post">
            ...
            <div class="row">
                <div class="col-md-12">
                    <a class="a-link">Slect Option Valiable</a>
                    <br>
                    ...
                    <!-- service  -->
                    <a @click="active1=!active1" class="a-link">Click bottom Add New Service Or Slect Option Valiable</a>
                    ...
                    <!-- partner  -->
                    <a @click="active2=!active2" class="a-link">Click bottom Add New Partner Or Slect Option Valiable</a>
