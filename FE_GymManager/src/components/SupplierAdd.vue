    ...
    <form @submit.prevent="AddSupplierFrom(supplier)" method="post">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <!-- role select  -->
                <p v-if="check==5">Select Status Of Device</p>
                ...
                <!-- end role select  -->
                <!-- type machine select  -->
                <a v-if="check==6" @click="active1=!active1" class="a-link">Click bottom Add New Type Machine Or Slect Option Valiable</a>
                ...
                <!-- department select  -->
                <a v-if="check==6" @click="active2 =! active2 " class="a-link">Click bottom Add New Department Or Slect Option Valiable</a>
                ...
                <br>
                <!-- Supplier select  -->
                 <a  v-if="check==6" @click="active3=!active3" class="a-link">Click bottom Add New Supplier Or Slect Option Valiable</a>
                ...
                <!-- User select  -->
                 <a  v-if="check==7" class="a-link">Slect Option Valiable Leader Of Department</a>
                ...
                <div class="form-group">
                    ...
                    <a class="btnContact text-light bg-dark  close" @click="showList" v-if="modal!=100">Quay Lai List</a>
                </div>
