...
<div class="grey-bg container-fluid">
    <section id="minimal-statistics">
        <div class="row">
            <div class="col-12 mt-3 mb-1">
                <p>THỐNG KÊ CÁC THIẾT BỊ PHÒNG GYM</p>
            </div>
        </div>
        <div class="row">
    ...
    <h3 class="list-device">Danh Sách Thiết Bị Phòng Gym </h3>
    <div class="table100 ver3 m-b-110">
        <div class="table100-head">
            <table>
                <thead>
                    <tr class="row100 head">
                        <th class="cell100 column1">Tên Thiết Bị</th>
                        <th class="cell100 column2">Loại Thiết Bị</th>
                        <th class="cell100 column3">Tình Trạng</th>
                        <th class="cell100 column4">Phòng Ban</th>
                    </tr>
                </thead>
            </table>
        </div>
            ...
            <table>
                <tbody>
                    ...
                    >
                        ...
                        <td class="cell100 column2 ">{{(item.typemachine)?item.typemachine.name:"chua co"}}</td>
                        <td class="cell100 column3">{{(item.status)?item.status.name:"chua co"}}</td>
                        <td class="cell100 column4">{{(item.department)?item.department.name:"chua co"}}</td>
                    </tr>
                </tbody>
            </table>
        </div>
